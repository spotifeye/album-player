...
import { faExpandArrowsAlt, faVolumeUp, faDesktop, faSlidersH, faPauseCircle, faRandom, faStepBackward, faPlayCircle, faStepForward, faRedo } from '@fortawesome/free-solid-svg-icons';
        ...
        <Row>
          <Col xs={3}>
            <div className={ply.playerleft}>
              ...
              <p style={{ margin: '0' }}>
                <br />
                <div>
                  <span id={ply.playersongname}>{this.props.albums[this.state.album].songs[this.state.song].songName}</span>
                </div>
                <div>
                  <span id={ply.playerartistname}>{this.props.artist}</span>
                </div>
              </p>
            </div>
          </Col>
          ...
          <Col xs={6}>
            <div className={ply.playermiddle}>
              <div id={ply.playermiddlebutton} onClick={this.handleRandomSongClick.bind(this)}>
                <FontAwesomeIcon icon={faRandom} size="sm" />
              </div>
              <div id={ply.playermiddlebutton} onClick={this.handlePreviousClick.bind(this)}>
              ...
              <div id={ply.playermiddlebutton} onClick={this.handleNextClick.bind(this)}>
                <FontAwesomeIcon icon={faStepForward} size="sm" />
              </div>
              <div id={ply.playermiddlebutton} onClick={this.handleRepeatSongClick.bind(this)}>
            ...
            <div className={ply.playermiddlebottom}>
              ...
              <div id={ply.playermiddlebottomelements}>
                <input className={ply.songslider} type="range" min="0" max={this.props.albums[this.state.album].songs[this.state.song].length} value={this.state.playValue} />
              </div>
              {this.props.albums[this.state.album].songs[this.state.song].length % 60 < 10 ? (
                <div id={ply.playermiddlebottomtextright}>
                  {Math.floor(this.props.albums[this.state.album].songs[this.state.song].length / 60)}:0{this.props.albums[this.state.album].songs[this.state.song].length % 60}
                </div>
              ) : (
                <div id={ply.playermiddlebottomtextright}>
                  {Math.floor(this.props.albums[this.state.album].songs[this.state.song].length / 60)}:{this.props.albums[this.state.album].songs[this.state.song].length % 60}
                </div>
              )}
            </div>
          </Col>
          ...
          <Col xs={3}>
            <div className={ply.playerright}>
              <div id={ply.playerrightbutton}>
                <FontAwesomeIcon icon={faExpandArrowsAlt} size="sm" />
              </div>
              <div id={ply.playerrightbutton}>
                <input className={ply.volumeslider} type="range" min="1" max="100" />
              </div>
              <div id={ply.playerrightbutton}>
